...
<!-------------------mask内容------------------->
<div class="proDets">
    <img class="off" src="${pageContext.request.contextPath}/static/img/temp/off.jpg"/>
    ...
    <div class="proCon clearfix">
        <div class="proImg fl">
            <img class="list" src="${pageContext.request.contextPath}/static/img/temp/proDet.jpg"/>
            <div class="smallImg clearfix">
                <img src="${pageContext.request.contextPath}/static/img/temp/proDet01.jpg"
                     data-src="${pageContext.request.contextPath}/static/img/temp/proDet01_big.jpg">
                <img src="${pageContext.request.contextPath}/static/img/temp/proDet02.jpg"
                     data-src="${pageContext.request.contextPath}/static/img/temp/proDet02_big.jpg">
                <img src="${pageContext.request.contextPath}/static/img/temp/proDet03.jpg"
                     data-src="${pageContext.request.contextPath}/static/img/temp/proDet03_big.jpg">
                <img src="${pageContext.request.contextPath}/static/img/temp/proDet04.jpg"
                     data-src="${pageContext.request.contextPath}/static/img/temp/proDet04_big.jpg">
            </div>
        </div>
        <div class="fr">
            <div class="proIntro">
                ...
                <div class="smallImg clearfix categ">
                    <p class="fl"><img src="${pageContext.request.contextPath}/static/img/temp/prosmall01.jpg"
                                       alt="白瓷花瓶+20支快乐花"
                                       data-src="${pageContext.request.contextPath}/static/img/temp/proBig01.jpg"></p>
                    <p class="fl"><img src="${pageContext.request.contextPath}/static/img/temp/prosmall02.jpg"
                                       alt="白瓷花瓶+20支兔尾巴草"
                                       data-src="${pageContext.request.contextPath}/static/img/temp/proBig02.jpg"></p>
                    <p class="fl"><img src="${pageContext.request.contextPath}/static/img/temp/prosmall03.jpg"
                                       alt="20支快乐花"
                                       data-src="${pageContext.request.contextPath}/static/img/temp/proBig03.jpg"></p>
                    <p class="fl"><img src="${pageContext.request.contextPath}/static/img/temp/prosmall04.jpg"
                                       alt="20支兔尾巴草"
                                       data-src="${pageContext.request.contextPath}/static/img/temp/proBig04.jpg"></p>
                </div>
                <p>数量</p>
