...
<div class="bj">
    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="nickname" required lay-verify="required"
                       placeholder="${sessionScope.user.userNick}" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn jia-user-information-save" lay-submit lay-filter="formDemo"
                        lay-filter="jia-edit-user-information">保存
                </button>
...
<div class="xg">
    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn jia-user-password-save" lay-submit lay-filter="jia-edit-user-password">保存
                </button>
                <button type="button" class="layui-btn layui-btn-primary jia-btn-cancle">取消</button>
            </div>
        </div>
...
<div class="xg-pay">
    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="paypassword" required lay-verify="required" placeholder="请输入支付密码"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn jia-user-paypassword-save" lay-submit lay-filter="jia-edit-user-paypassword">
                    保存
                </button>
                <button type="button" class="layui-btn layui-btn-primary jia-btn-cancle">取消</button>
            </div>
